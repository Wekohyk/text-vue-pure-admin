export default {
  ...
  feature: {
    ...
    dimensional_name: 'Qr code (generated based on qrcode)',
    img_link: 'Img tag',
    style_config: 'Style configuration',
    click_event: 'Click event',
    asynchronous_content: 'Asynchronous content',
    lose_effect: 'Lose effect',
    ...
    danmaku: 'Barrage assembly',
    danmaku_text:
      'The bullet screen component uses the open source vue3-danmakuS',
    play: 'Play',
    stop: 'Stop',
    mode: 'Mode: ',
    ...
    enter_comment:
      'After entering the comment, press enter to send the barrage',
    load_successfully: 'Load successfully',
    custom_ffmpeg: 'A frame-cutting tool based on custom compiled FFmpeg',
    drag_and_drop:
