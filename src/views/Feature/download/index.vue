<template>
  <div class="m-20">
    <div class="flex items-center b-b-1 b-b-solid b-b-#E5E7EB pb-20">
      <div class="font-600 mr-40">{{ $t('feature.file_download') }}</div>
    </div>
    ...
    <div class="flex flex-wrap mt-20">
      ...
      <el-button
        ...
        "
      >
        {{ $t('feature.download_according') }}
      </el-button>

      <el-button @click="down">
        {{ $t('feature.download_file_stream') }}
      </el-button>
    </div>
  </div>
</template>
