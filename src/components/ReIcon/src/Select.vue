...
watch(
  ...
  () =>
    (totalPage.value = copyIconList[currentActiveType.value].filter(
      (i: string | string[]) => i.includes(filterValue.value),
    ).length),
  { immediate: true },
);
watch(
      ...
      <template #append>
        ...
        >
          ...
          <el-input
            v-model="filterValue"
            class="px-2 pt-2"
            :placeholder="$t('element.search_icon')"
            clearable
          />
            ...
            >
              <el-scrollbar height="220px">
                ...
                <el-empty
                  ...
                  :description="`${filterValue}${$t('element.icon_not_exist')}`"
                  :image-size="60"
                />
              </el-scrollbar>
            </el-tab-pane>
          ...
          <div
            class="w-full h-30 flex items-center overflow-auto border-t border-[#e5e7eb]"
          >
            <el-pagination
