...
const realBoxHeight = ref<number | undefined>(0);
const copyHtml = ref('');
// single 单步滚动的定时器
// eslint-disable-next-line no-undef
let singleWaitTime: string | number | NodeJS.Timeout | null | undefined = null;
// move动画的animationFrame定时器
let reqFrame: number | null = null;
let startPos: { x: any; y: any } | null = null;
//记录touchStart时候的posY
...
function touchStart(e: { targetTouches: any[] }) {
...
// 鼠标滚轮事件
function wheel(e: { deltaY: number }) {
  if (
